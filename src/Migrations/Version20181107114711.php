 ...
 */
final class Version20181107114711 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ADD username VARCHAR(255) NOT NULL, DROP user_id_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ADD user_id_id INT NOT NULL, DROP username');
